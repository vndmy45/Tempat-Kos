...
class TestExactMatchCommand extends Command
{
    protected $signature = 'test:exact-match {--harga=} {--rating=} {--jarak=} {--fasilitas=*} {--survey=}';
    protected $description = 'Test exact matching between database and controller using rounded values';

    public function handle()
    {
        $this->info("=== TEST EXACT MATCH DATABASE vs CONTROLLER ===");
        ...
        // Test exact matching with rounded values
        $this->info("\n=== TEST EXACT MATCHING ===");
        $exactMatches = 0;
        $totalKos = 0;
